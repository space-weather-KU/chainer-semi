...
class SunPredict(chainer.Chain):
...
plot_sun_image(img.data[0], "image-before.png", title = 'before')

img = get_normalized_image_variable(t+dt)
plot_sun_image(img.data[0], "image-after.png", title = 'after')
